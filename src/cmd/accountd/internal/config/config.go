...
// LoadConfig loads the accountd service configuration and returns a map of key/value pairs or an error
...
// LoadSecrets loads the accountd service's secrets and returns a map of key/value pairs or an error
